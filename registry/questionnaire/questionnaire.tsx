...
/**
 * A multi-step question flow. The primitive owns the ordered items, the active
 * item, answer state, validation, progress and navigation; the page, card or
 * dialog around it owns closing, persistence and transport.
 */
...
/** "Question 2 of 5" — reserves its line so the layout doesn't jump. */
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        // Takes back the gap when no description follows it.
...
/**
 * One selectable answer. The real input is stretched invisibly over the whole
 * row, so the entire card is the hit target and focus rings follow it; the
 * indicator is a square for checkboxes and a circle for radios.
 */
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex min-h-11 cursor-pointer items-start gap-2.5 rounded-lg border border-input bg-transparent px-3 py-2.5 text-start text-sm transition-colors outline-none select-none dark:bg-input/20",
        "hover:bg-muted/50 data-checked:border-primary data-checked:bg-muted dark:data-checked:bg-muted data-invalid:border-destructive",
...
/** Secondary line under a choice's label. */
...
/** A freeform answer alongside the choices. */
  ...
  return (
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          "h-8 min-h-11 w-full min-w-0 rounded-lg border border-input bg-transparent px-2.5 py-1 text-base transition-[color,box-shadow,background-color] outline-none sm:min-h-0 md:text-sm dark:bg-input/30",
...
/**
 * The navigation row. Three tracks keep Previous at the start and Skip / Next
 * at the end, so buttons don't shift as they appear and disappear.
 */
